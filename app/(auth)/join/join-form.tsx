...
import { acceptInvite } from '@/app/actions/join'
...
export default function JoinForm({ token, email }: { token: string; email: string }) {
  ...
  return (
    <>
      ...
      <p className="mb-1 text-sm text-white/50">Setting up account for</p>
      <p className="mb-6 text-sm font-medium text-[#2dd4bf]">{email}</p>
