...
export default function SetPasswordPage() {
  ...
  return (
    <>
      <h1 className="mb-2 text-2xl font-semibold tracking-tight text-white">Set your password</h1>
      <p className="mb-8 text-sm text-white/50">Choose a password to complete your account setup.</p>
